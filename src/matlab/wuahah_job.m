%-----------------------------------------------------------------------
% Job saved on 13-Aug-2017 14:28:13 by cfg_util (rev $Rev: 6134 $)
% spm SPM - SPM12 (6225)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.spatial.coreg.estimate.ref = {'F:\Mydata\PaperDataSets\DTI\PPMI\3102\3102_dwi.nii,1'};
matlabbatch{1}.spm.spatial.coreg.estimate.source = {'F:\Mydata\PaperDataSets\DTI\PPMI\3102\3102_T1.nii,1'};
